...
export class CategoryPageComponent implements OnInit {
	...
	public products$: Observable<IProductApi> | null = null;

	// tslint:disable-next-line: ban-types
	public brands$: Observable<Object> | null = null;
	...
	public filterByParams(data: { prices: number[]; text: string; brands: string[] }): void {
		this.router.navigate(['category/', `${this.selectedSubCategory}`], {
			queryParams: {
